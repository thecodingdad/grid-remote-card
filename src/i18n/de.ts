export default {
  ...
  "Empty fields fall back to the global color settings.": "Leere Felder verwenden die globalen Farb-Einstellungen.",
  "(active)": "(aktiv)",
  ...
  "Unknown item type: {type}": "Unbekannter Item-Typ: {type}",
