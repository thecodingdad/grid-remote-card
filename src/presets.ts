...
export const REMOTE_PRESETS: Record<string, PresetDefinition> = {
  ...
  bravia_tv: {
    ...
    items: [
      ...
      { type: 'button', row: 6, col: 0, icon: 'mdi:arrow-u-left-top', _secondary: true,
        tap_action: { action: 'perform-action', perform_action: 'remote.send_command', data: { command: 'Return' } } },
      { type: 'button', row: 6, col: 1, icon: 'mdi:home', _secondary: true,
        tap_action: { action: 'perform-action', perform_action: 'remote.send_command', data: { command: 'Home' } } },
      { type: 'button', row: 6, col: 2, icon: 'mdi:cog', _secondary: true,
        tap_action: { action: 'perform-action', perform_action: 'remote.send_command', data: { command: 'ActionMenu' } } },
      { type: 'button', row: 7, col: 0, icon: 'mdi:skip-previous',
        tap_action: { action: 'perform-action', perform_action: 'media_player.media_previous_track' } },
      { type: 'button', row: 7, col: 1, icon: 'mdi:play-pause',
        tap_action: { action: 'perform-action', perform_action: 'media_player.media_play_pause' } },
  ...
  android_tv: {
    ...
    items: [
      ...
      { type: 'numbers', row: 0, col: 1, icon: 'mdi:dialpad', _secondary: true,
        buttons: {
          '0': { tap_action: { action: 'perform-action', perform_action: 'remote.send_command', data: { command: '0' } } },
          '1': { tap_action: { action: 'perform-action', perform_action: 'remote.send_command', data: { command: '1' } } },
          '2': { tap_action: { action: 'perform-action', perform_action: 'remote.send_command', data: { command: '2' } } },
          '3': { tap_action: { action: 'perform-action', perform_action: 'remote.send_command', data: { command: '3' } } },
          '4': { tap_action: { action: 'perform-action', perform_action: 'remote.send_command', data: { command: '4' } } },
          '5': { tap_action: { action: 'perform-action', perform_action: 'remote.send_command', data: { command: '5' } } },
          '6': { tap_action: { action: 'perform-action', perform_action: 'remote.send_command', data: { command: '6' } } },
          '7': { tap_action: { action: 'perform-action', perform_action: 'remote.send_command', data: { command: '7' } } },
          '8': { tap_action: { action: 'perform-action', perform_action: 'remote.send_command', data: { command: '8' } } },
          '9': { tap_action: { action: 'perform-action', perform_action: 'remote.send_command', data: { command: '9' } } },
